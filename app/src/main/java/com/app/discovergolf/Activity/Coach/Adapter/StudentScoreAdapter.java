...
public class StudentScoreAdapter extends  RecyclerView.Adapter<StudentScoreAdapter.ViewHolder> implements Filterable {
    ...
    public StudentScoreAdapter(Context context, List<TeamScoreModel> list){
    ...
    public void selectNavItem(TeamScoreModel teamScoreModel) {
        callback.onMatrixClick(teamScoreModel);
    }
